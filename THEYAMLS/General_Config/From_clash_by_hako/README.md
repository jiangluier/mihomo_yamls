...
- **路径**: `service-single-provider.yaml` | **大小**: 25.9 KB | [查看源码](https://github.com/jiangluier/mihomo_yamls/blob/main/THEYAMLS/General_Config/From_clash_by_hako/service-single-provider.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
...
- **路径**: `region-single-provider.yaml` | **大小**: 15.1 KB | [查看源码](https://github.com/jiangluier/mihomo_yamls/blob/main/THEYAMLS/General_Config/From_clash_by_hako/region-single-provider.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
...
- **路径**: `region-dual-provider.yaml` | **大小**: 20.9 KB | [查看源码](https://github.com/jiangluier/mihomo_yamls/blob/main/THEYAMLS/General_Config/From_clash_by_hako/region-dual-provider.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
<summary>🔍 策略组 (33个)</summary>
